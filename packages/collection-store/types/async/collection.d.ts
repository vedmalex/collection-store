...
export declare function serializeIndex<T extends Item>(res: IndexDef<T>): SerializedIndexDef;
export declare function deserializeIndex<T extends Item>(res: SerializedIndexDef): IndexDef<T>;
